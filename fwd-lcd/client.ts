namespace fwdSensors {
    ...
    //% block.de="LCD initialisieren"
    //% block.fr="initialiser LCD"
    //% block.it="inizializza LCD"
    //% block.es="inicializar LCD"
    //% block.el="αρχικοποίηση LCD"
    ...
    //% block.de="runde $number_ auf $decimals Nachkommastellen"
    //% block.fr="arrondir $number_ à $decimals décimales"
    //% block.it="arrotonda $number_ a $decimals decimali"
    //% block.es="redondear $number_ a $decimals decimales"
    //% block.el="στρογγυλοποίηση $number_ σε $decimals δεκαδικά"
    ...
    export class LCDClient extends modules.CursorCharacterScreenClient {
        ...
        //% block="clear $this"
        //% block.de="$this Bildschirm löschen"
        //% block.fr="effacer $this"
        //% block.it="cancella $this"
        //% block.es="borrar $this"
        //% block.el="καθαρισμός $this"
        ...
        //% block.de="zeige Text $string_ auf Zeile $line von $this"
        //% block.fr="afficher texte $string_ sur ligne $line de $this"
        //% block.it="stampa testo $string_ su riga $line di $this"
        //% block.es="imprimir texto $string_ en línea $line de $this"
        //% block.el="εκτύπωση $string_ στη γραμμή $line του $this"
        ...
        //% block.de="zeige Text $string_ im Quadrant $quadrant von $this"
        //% block.fr="afficher texte $string_ dans quadrant $quadrant de $this"
        //% block.it="stampa testo $string_ nel quadrante $quadrant di $this"
        //% block.es="imprimir texto $string_ en cuadrante $quadrant de $this"
        //% block.el="εκτύπωση $string_ στο τεταρτημόριο $quadrant του $this"
        ...
        //% block.de="zeige Zahl $number_ auf Zeile $line von $this"
        //% block.fr="afficher nombre $number_ sur ligne $line de $this"
        //% block.it="stampa numero $number_ su riga $line di $this"
        //% block.es="imprimir número $number_ en línea $line de $this"
        //% block.el="εκτύπωση αριθμού $number_ στη γραμμή $line του $this"
        //% line.min=1 line.max=2 line.defl=1
        ...
        //% block.de="zeige Zahl $number_ im Quadrant $quadrant von $this"
        //% block.fr="afficher nombre $number_ dans quadrant $quadrant de $this"
        //% block.it="stampa numero $number_ nel quadrante $quadrant di $this"
        //% block.es="imprimir número $number_ en cuadrante $quadrant de $this"
        //% block.el="εκτύπωση αριθμού $number_ στο τεταρτημόριο $quadrant του $this"
        //% quadrant.min=1 quadrant.max=4 quadrant.defl=1
